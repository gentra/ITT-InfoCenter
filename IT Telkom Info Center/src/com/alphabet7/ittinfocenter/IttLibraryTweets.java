...
public class IttLibraryTweets extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		header.setText("@ittelkomlibrary");
	...
	public boolean onContextItemSelected(MenuItem item) {
		...
		case 1:
			...
			clipboard.setText("@ittelkomlibrary: " + mCopyText);
			return true;
		default:
	...
	private class TweetsTask extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... params) {
			...
			adapter = new ArrayAdapter<String>(IttLibraryTweets.this,
					R.layout.tweetsrow, R.id.text);

			List<twitter4j.Status> statuses;
			try {
				// Gets the ittelkom's timeline
				statuses = twitter.getUserTimeline("ittelkomlibrary");
		...
		protected void onPreExecute() {
			super.onPreExecute();
			progressDialog = new ProgressDialog(IttLibraryTweets.this);
